...
class ConvBNReLU(nn.Sequential):
    def __init__(self, in_planes, out_planes, kernel_size=3, stride=1, groups=1, norm_layer=None, comp=True, g=4, r=2, progressive=False):
...
class InvertedResidual(nn.Module):
    def __init__(self, inp, oup, stride, expand_ratio, norm_layer=None, comp=True, g=4, r=2, progressive=False):
        ...
        if expand_ratio != 1:
            # pw
            layers.append(ConvBNReLU(inp, hidden_dim, kernel_size=1, norm_layer=norm_layer, comp=comp, g=g, r=r, progressive=progressive))
        layers.extend([
            # dw
...
class MobileNetV2(nn.Module):
    def __init__(self,
        ...
        features = [ConvBNReLU(3, input_channel, stride=2, norm_layer=norm_layer, comp=False)]
